...
//c) WAP to implement Gauss Elimination with Complete pivoting 

//Row as well as Col swapping
...
//	ans[m] = cons[m]/mat[m][m];	// last elem z from w,x,y,z
